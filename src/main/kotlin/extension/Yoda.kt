...
const val ROOTDIR = "/Users/rivabu/aaa/kotlin/kotlin-cookbook"

fun String.yoda(): String {
    val key = File(ROOTDIR + "/src/main/resources/yoda_key.txt").readText()
...
fun main() {
    File(ROOTDIR + "/src/main/resources/strings.txt").useLines { sequence ->
